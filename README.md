...
> 🎉 We release the 16.54M parameter checkpoint and generation script with corresponding benchmark results in [`note/`](note/). See [`note/README.md`](note/README.md) for details.
